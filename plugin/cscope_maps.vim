...
if has("cscope")
    ...
    " this works i=only in gui mode 
    map <C-space>s :scs find s <C-R>=expand("<cword>")<CR><CR>	
    map <C-space>g :scs find g <C-R>=expand("<cword>")<CR><CR>	
    ...
    " this is for termnal translation I don't know how to remove translation
    " in vim
    map <C-@>s :scs find s <C-R>=expand("<cword>")<CR><CR>	
    map <C-@>g :scs find g <C-R>=expand("<cword>")<CR><CR>	
    map <C-@>c :scs find c <C-R>=expand("<cword>")<CR><CR>	
    map <C-@>t :scs find t <C-R>=expand("<cword>")<CR><CR>	
